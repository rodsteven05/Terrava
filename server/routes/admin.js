...
const { createSeller, getUsers, updateUserRole, updateUserProfile, archiveUser, restoreUser, getDashboardStats, getSalesReport, getBuyers, archiveListing, restoreListing } = require('../controllers/adminController');
...
router.put('/users/:id/profile', authenticate, authorize('admin'), updateUserProfile);
